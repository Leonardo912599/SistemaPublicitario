    ...
    <body>
        <header>
            <ul class="container justify-content-end">
                ...
                <div class="menu">
                    <i id="icono" style="display: none; font-size: 36px;" class="bi bi-person-circle"></i>
                    <button id="menuButton" class="custom-button">Iniciar Sesión</button>
                    <div class="dropdown-content" id="myDropdown">
                        <a href="login.jsp" id="loginLink">Iniciar Sesión</a>
                        <a href="#" id="nombreApellido" style="display: none">${datos.getNombre()} ${datos.getApellidos()}</a>
                        <a href="#" id="miCuentaLink" style="display: none">Mi cuenta</a>
                        <a href="#" id="favoritosLink" style="display: none">Favoritos</a>
                        <a href="#" id="publicarLink" style="display: none">Publicar</a>
                        <form action="ValidarServlet?accion=salir" method="POST">
                            <a id="salir" style="display:none;"><button name="accion" name="salir">Cerrar Sesión</button></a>
                        </form>
                    </div>
                </div>
            </ul>
